        ...
        <div class="col-lg-12 card">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
                        <br>
                        <div class="from-group">
                            {{ Form::label('button_size','Button Size: ') }}
                            {{ Form::text('button_size',null,['class'=>'form-control','placeholder'=>'Button Size.']) }}
                        </div>
                    </div>
                            ...
                            <div class="col-lg-12 table-responsive">
                                <table class="table table-striped">
                                    ...
                                    <tr id="button_row_add1">
                                        ...
                                        <td>
                                            <div class="form-group {{ $errors->has('color_button1') ? 'has-error' : '' }}">
                                                {{--{{ Form::label('','Unit : ') }}--}}
                                                {{ Form::text('color_button1',null,['id'=>'color_button1','class'=>'form-control','placeholder'=>'Color']) }}
                                                @if($errors->has('color_button1'))
                                                    <span class="help-block">
                                                <strong>{{ $errors->first('color_button1') }}</strong>
                                            </span>
                                                @endif
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            <div class="form-group{{ $errors->has('button_color1') ? 'has-error' : '' }}">
                                                {{ Form::text('button_color1',null,['id'=>'button_color1','class'=>'form-control','placeholder'=>'Enter Color']) }}
                                                @if ($errors->has('button_color1'))
                                                    <span class="help-block">
                                                        <strong>{{ $errors->first('button_color1') }}</strong>
                                                     </span>
                                                @endif
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            <div class="form-group{{ $errors->has('button_details1') ? 'has-error' : '' }}">
                                                {{ Form::text('button_details1',null,['id'=>'button_details1','class'=>'form-control','placeholder'=>'Enter Details']) }}
                                                @if ($errors->has('button_details1'))
                                                    <span class="help-block">
                                                        <strong>{{ $errors->first('button_details1') }}</strong>
                                                     </span>
                                                @endif
                                            </div>
                                        </td>
...
<script>
    ...
    function addRow(){
        ...
        $('input[id^="button_details"]:last').prop('id','button_details'+num).prop('name','button_details'+num);
