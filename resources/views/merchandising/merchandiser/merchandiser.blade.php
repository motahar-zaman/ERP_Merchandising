...
@section('title','Create Merchandiser')
...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Create Merchandiser</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item active">Create Merchandiser</li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="col-md-8">
                        <div class="card card-info">
                            <div class="card-header">
                                <h3 class="card-title">Create Merchandiser</h3>
                            </div>
                            <form method="post">
                                @csrf
                                <div class="card-body">
                                    <div class="form-group row {{ $errors->has('name') ? 'has-error' : '' }}">
                                        ...
                                        <div class="col-md-8 pl-0 pr-0">
                                            <input type="text" class="form-control" name="name" id="style_name" placeholder="merchandiser name" value="" required>
                                    ...
                                    <div class="form-group row {{ $errors->has('email') ? 'has-error' : '' }}">
                                        ...
                                        <div class="col-md-8 pl-0 pr-0">
                                            <input type="text" class="form-control" name="email" id="email" placeholder="merchandiser email" value="" required>
                                    ...
                                    <div class="form-group row {{ $errors->has('phone') ? 'has-error' : '' }}">
                                        ...
                                        <div class="col-md-8 pl-0 pr-0">
                                            <input type="number" class="form-control" name="phone" id="phone" placeholder="merchandiser phone no" value="" required>
                                    ...
                                    <div class="form-group row {{ $errors->has('designation') ? 'has-error' : '' }}">
                                        ...
                                        <div class="col-md-8 pl-0 pr-0">
                                            <input type="text" class="form-control" name="designation" id="designation" placeholder="merchandiser designation" value="" required>
