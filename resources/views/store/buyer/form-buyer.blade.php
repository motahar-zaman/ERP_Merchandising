...
<div class="card-body">
    ...
    <div class="form-group row {{ $errors->has('name') ? 'has-error' : '' }}">
        <label for="name" class="col-md-2 offset-1 control-label">Buyer Name<span class="text-danger">*</span></label>
        <div class="col-md-8">
    ...
    <div class="form-group row {{ $errors->has('phone') ? 'has-error' : '' }}">
        <label for="name" class="col-md-2 offset-1 control-label">Buyer Phone</label>
        <div class="col-md-8">
    ...
    <div class="form-group row {{ $errors->has('email') ? 'has-error' : '' }}">
        <label for="email" class="col-md-2 offset-1 control-label">Buyer E-Mail</label>
        <div class="col-md-8">
    ...
    <div class="form-group row {{ $errors->has('address') ? 'has-error' : '' }}">
        <label for="name" class="col-md-2 offset-1 control-label">Buyer Address</label>
        <div class="col-md-8">
