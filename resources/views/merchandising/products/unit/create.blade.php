                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="card bg-light">
                                <div class="card-body">
                                    {{ Form::model($units= new \App\ProductUnit,['action'=>'Inventory\ProductUnitController@store','method'=>'POST', 'class'=>'form-horizontal']) }}
                                    @include('merchandising.products.unit.form')
                                    {{ Form::close() }}
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-8">
                            {{--load list data --}}
                            @include('merchandising.products.unit.list')
                        </div>
                        @endcan
                        @can('planning')
                         <div class="col-lg-12">
