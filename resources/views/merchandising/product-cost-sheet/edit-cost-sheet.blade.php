...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6 ">
                    <h1 style="margin-left: 20px">Cost Sheet</h1>
                </div>
                <div class="col-sm-6">
                    ...
                    <div class="card">
                        <div class="card-header d-flex p-0">
                            <ul class="nav nav-pills ml-auto p-2">
                                ...
                                <li class="nav-item"><a class="nav-link" href="#appointed_trims" data-toggle="tab" style="font-weight: bold;">Appointed Trims & Accessories</a></li>
                                <li class="nav-item"><a class="nav-link" href="#other_trims" data-toggle="tab" style="font-weight: bold;">Other Trims</a></li>
                                <li class="nav-item"><a class="nav-link" href="#other_cost" data-toggle="tab" style="font-weight: bold;">Other Cost</a></li>
                            </ul>
                        </div>
                        {{ Form::model($cost_breakdown,['action'=>['Merchandise\ProductCostSheetController@update',$cost_breakdown->id],'method'=>'patch','files'=>true]) }}
