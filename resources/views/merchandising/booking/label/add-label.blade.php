...
@section('content')
    ...
    <section class="content container-fluid">
        ...
        <div class="col-lg-12 card">
            {{ Form::open(['action'=>'Merchandise\LabelBookingController@store','method'=>'POST', 'class'=>'form-horizontal']) }}
            <div class="row">
                    ...
                    <div class="col-lg-12 table-responsive">
                        <table class="table table-striped">
                            ...
                            <tr id="label_row_add1">
                                ...
                                <td>
                                    <div class="form-group {{ $errors->has('care_instruction1') ? 'has-error' : '' }}">
                                        {{--{{ Form::label('','Unit : ') }}--}}
                                        {{ Form::text('care_instruction1',null,['id'=>'care_instruction1','class'=>'form-control','placeholder'=>'Care Instruction']) }}
                                        @if($errors->has('care_instruction1'))
                                            <span class="help-block">
                                                <strong>{{ $errors->first('care_instruction1') }}</strong>
                                            </span>
                                        @endif
                                    </div>
                                </td>
...
<script>
    ...
    function addRow(){
        ...
        $('input[id^="care_instruction"]:last').prop('id','care_instruction'+num).prop('name','care_instruction'+num);
