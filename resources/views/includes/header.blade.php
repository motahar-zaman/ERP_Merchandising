    ...
    <li class="nav-item dropdown" style="margin-top:4px;">
        ...
        <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
            ...
            <li class="user-footer">
                <div class="pull-left">
                    <a href="{{ action('UserController@show') }}" class="btn btn-default btn-flat">Profile</a>
                </div>
                {{-- <div class=" col-md-7" >
                        <a href="{{route('change.password')}}" class="btn btn-default btn-flat" ><span style="color:black">Change Password</span></a>
                    </div> --}}
