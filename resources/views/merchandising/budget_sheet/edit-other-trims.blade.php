                      ...
                      <tr id="col{{$other_num}}">
                          <td>
                              <div class="form-group {{ $errors->has('provider'.$other_num) ? 'has-error' : '' }}">
                                  {{--{{ Form::label('','Unit : ') }}--}}
                                  {{ Form::select('provider'.$other_num,$repository->suppliers(),$pack ? $pack->provider :null,['id'=>'provider'.$other_num,'class'=>'form-control','placeholder'=>'Select Supplier']) }}
                          ...
                          <td>
                              <div class="form-group {{ $errors->has('other_trim_id'.$other_num) ? 'has-error' : '' }}">
                                  {{--{{ Form::label('','Unit : ') }}--}}
                                  {{ Form::select('other_trim_id'.$other_num,$repository->otherTrims(),$pack ? $pack->other_trim_id :null,['id'=>'other_trim_id'.$other_num,'class'=>'form-control','placeholder'=>'Select Fabric']) }}
                            ...
                            <td>
                                <div class="form-group {{ $errors->has('other_trim_description'.$other_num) ? 'has-error' : '' }}">
                                    {{--{{ Form::label('','Unit : ') }}--}}
                                    {{ Form::text('other_trim_description'.$other_num,$pack ? $pack->other_trim_description :null,['id'=>'other_trim_description'.$other_num,'class'=>'form-control','placeholder'=>'Description']) }}
                            ...
                            <td>
                                <div class="form-group {{ $errors->has('qty'.$other_num) ? 'has-error' : '' }}">
                                    {{--{{ Form::label('','Unit : ') }}--}}
                                    {{ Form::text('qty'.$other_num,$pack ? $pack->qty :null,['id'=>'qty'.$other_num,'class'=>'form-control ','placeholder'=>'Required quantity']) }}
                            ...
                            <td>
                                <div class="form-group {{ $errors->has('price'.$other_num) ? 'has-error' : '' }}">
                                    {{--{{ Form::label('','Unit : ') }}--}}
                                    {{ Form::text('price'.$other_num,$pack ? $pack->price :null,['id'=>'price'.$other_num,'class'=>'form-control','placeholder'=>'Unit Price/mtr  ']) }}
                            ...
                            <td>
                                <div class="form-group {{ $errors->has('cost'.$other_num) ? 'has-error' : '' }}">
                                    {{--{{ Form::label('','Unit : ') }}--}}
                                    {{ Form::text('cost'.$other_num,$pack ? $pack->cost :null,['id'=>'cost'.$other_num,'class'=>'form-control last_salary','placeholder'=>'Appointed Trims Cost US$ With DZN ']) }}
