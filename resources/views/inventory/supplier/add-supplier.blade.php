...
@section('title','Save-Supplier Inventory')
        ...
        <div class="col-lg-12">
            ...
            <div class="card"><br>
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-4">
                            <h2 class="text-info text-center">Add A Supplier</h2><hr>
                            ...
                            <div class="form-group">
                                <div class="">
                                    {{ Form::submit('Save Supplier / Party', ['class'=>'btn btn-success btn-block']) }}
                                </div>
                            </div>
                            {!! Form::close() !!}
                        </div>
