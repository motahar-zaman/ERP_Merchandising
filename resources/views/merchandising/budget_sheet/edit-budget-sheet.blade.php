...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6 ">
                    <h1 style="margin-left: 20px">Edit Budget Sheet</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item active">Edit Budget Sheet</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
                    ...
                    <div class="card">
                        <div class="card-header d-flex p-0">
                            <ul class="nav nav-pills ml-auto p-2">
                                ...
                                <li class="nav-item"><a class="nav-link" href="#other_trims" data-toggle="tab" style="font-weight: bold;">Packaging</a></li>
                                <li class="nav-item"><a class="nav-link" href="#other_cost" data-toggle="tab" style="font-weight: bold;">Other Cost</a></li>
                            </ul>
                        </div>

                        {{ Form::open(['action'=>'Merchandise\BudgetSheetController@store','method'=>'POST', 'class'=>'form-horizontal']) }}
                        <div class="card-body">
                            <ul>
                                @php $i=0; @endphp
                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="basic_info">
                                   @include('merchandising.budget_sheet.edit-basic-info')
                                </div>
                                <!-- /.tab-pane -->
                                <div class="tab-pane" id="fabric_content">
                                    @include('merchandising.budget_sheet.edit-fabric-content')
                                </div>

                                {{--//Start short-course-information added by Ahmed--}}
                                <div class="tab-pane" id="appointed_trims">
                                    @include('merchandising.budget_sheet.edit-appointed-trims')
                                </div>
                                <!-- /.end short-course-information  -->

                                {{--//Start short-course-information added by Ahmed--}}
                                <div class="tab-pane" id="other_trims">
                                    @include('merchandising.budget_sheet.edit-other-trims')
                                </div>
                                <!-- /.end short-course-information  -->

                                {{--//Start short-course-information added by Ahmed--}}
                                <div class="tab-pane" id="other_cost">
                                    @include('merchandising.budget_sheet.edit-other-cost')
                                </div>
                                <!-- /.end short-course-information  -->
                            </div>
                            <!-- /.tab-content -->
