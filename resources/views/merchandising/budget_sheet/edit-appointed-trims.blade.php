                    ...
                    <tr id="row{{$trim_num}}">
                          <td>
                              <div class="form-group {{ $errors->has('distributor'.$trim_num) ? 'has-error' : '' }}">
                                  {{--{{ Form::label('','Unit : ') }}--}}
                                  {{ Form::select('distributor'.$trim_num,$repository->suppliers(),$trim ? $trim->distributor:null,['id'=>'distributor'.$trim_num,'class'=>'form-control','placeholder'=>'Select Supplier']) }}
                            ...
                            <td>
                                <div class="form-group {{ $errors->has('trim_id'.$trim_num) ? 'has-error' : '' }}">
                                    {{--{{ Form::label('','Unit : ') }}--}}
                                    {{ Form::select('trim_id'.$trim_num,$repository->trims(),$trim ? $trim->trim_id : null,['id'=>'trim_id'.$trim_num,'class'=>'form-control','placeholder'=>'Select Trims']) }}
                            ...
                            <td>
                                <div class="form-group {{ $errors->has('reference'.$trim_num) ? 'has-error' : '' }}">
                                    {{--{{ Form::label('','Unit : ') }}--}}
                                    {{ Form::text('reference'.$trim_num,$trim ? $trim->reference : null,['id'=>'reference'.$trim_num,'class'=>'form-control address','placeholder'=>'']) }}
                          ...
                          <td>
                              <div class="form-group {{ $errors->has('color'.$trim_num) ? 'has-error' : '' }}">
                                  {{--{{ Form::label('','Unit : ') }}--}}
                                  {{ Form::text('color'.$trim_num,$trim ? $trim->color : null,['id'=>'color'.$trim_num,'class'=>'form-control telNo','placeholder'=>'Color']) }}
                            ...
                            <td>
                                <div class="form-group {{ $errors->has('trims_description'.$trim_num) ? 'has-error' : '' }}">
                                    {{--{{ Form::label('','Unit : ') }}--}}
                                    {{ Form::text('trims_description'.$trim_num,$trim ? $trim->trims_description : null,['id'=>'trims_description'.$trim_num,'class'=>'form-control telNo','placeholder'=>'Ex. 52895']) }}
                            ...
                            <td>
                                <div class="form-group {{ $errors->has('required_qty'.$trim_num) ? 'has-error' : '' }}">
                                    {{--{{ Form::label('','Unit : ') }}--}}
                                    {{ Form::text('required_qty'.$trim_num,$trim ? $trim->required_qty : null,['id'=>'required_qty'.$trim_num,'class'=>'form-control ','placeholder'=>'Experience To']) }}
                            ...
                            <td>
                                <div class="form-group {{ $errors->has('trims_price'.$trim_num) ? 'has-error' : '' }}">
                                    {{--{{ Form::label('','Unit : ') }}--}}
                                    {{ Form::text('trims_price'.$trim_num,$trim ? $trim->trims_price : null,['id'=>'trims_price'.$trim_num,'class'=>'form-control','placeholder'=>'Ex. Leave Reason']) }}
                            ...
                            <td>
                                <div class="form-group {{ $errors->has('trims_cost'.$trim_num) ? 'has-error' : '' }}">
                                    {{--{{ Form::label('','Unit : ') }}--}}
                                    {{ Form::text('trims_cost'.$trim_num,$trim ? $trim->trims_cost : null,['id'=>'trims_cost'.$trim_num,'class'=>'form-control','placeholder'=>'Trim Cost']) }}
