...
@section('title','Save-Group Inventory')
        ...
        <div class="col-lg-12">
            ...
            <div class="card"><br>
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-4">
                            <h2 class="text-info text-center">Add A Group</h2><hr>
                            {!! Form::open(['method'=>'POST', 'class'=>'form-horizontal']) !!}
                            <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                                {{Form::label('details', 'Grade Name', ['class'=>'label-control'])}}
                            ...
                            <div class="form-group{{ $errors->has('details') ? ' has-error' : '' }}">
                                {{Form::label('details', 'Grade Description', ['class'=>'label-control'])}}
                            ...
                            <div class="form-group">
                                <div class="">
                                    {{ Form::submit('Save Department', ['class'=>'btn btn-success btn-block']) }}
                                </div>
                            </div>
                            {!! Form::close() !!}
                        </div>
                        ...
                        <div class="col-lg-8">
                            ...
                            <table class="table table-hover table-bordered">
                                <thead>
                                <th colspan="5"> <h1 class="text-center text-info">Group's List</h1></th>
                                    <tr>
                                        <th>#SL</th>
                                        <th>Name</th>
                                        <th>Description</th>
                                ...
                                @for($i=1;$i<10;$i++)
                                    <tr>
                                        <td> {{ $i }} </td>
                                        <td> Well-Group Group {{ $i }} </td>
                                        <td> Group description {{ $i }} </td>
                                        <td>
