...
@section('title','WELL-GROUP | Create Efficiency')
...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/jquery-confirm/3.3.4/jquery-confirm.min.css"> 
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 style="margin-left: 20px"><b>Create Efficiency</b></h1>
                </div>
                <div class="col-sm-6">
    ...
    {{ Form::open(['action'=>'Planning\EfficiencyController@store','method'=>'POST','id'=>'form', 'class'=>'form-horizontal','enctype'=>'multipart/form-data']) }}
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                                    <div class="from-group">
                                        ...
                                        <input type="number" id="efficiency" name="efficiency" class="form-control" placeholder="Efficiency (%)">
