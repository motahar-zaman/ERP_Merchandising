...
@section('title','Save-Department Inventory')
        ...
        <div class="col-lg-12">
            ...
            <div class="card"><br>
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-4">
                            <h2 class="text-info text-center">Add A Grade</h2><hr>
                            {!! Form::open(['method'=>'POST', 'class'=>'form-horizontal']) !!}
                            <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                                {{Form::label('details', ' Name', ['class'=>'label-control'])}}
                        ...
                        <div class="col-lg-8">
                            ...
                            <table class="table table-hover table-bordered">
                                ...
                                @for($i=1;$i<10;$i++)
                                    <tr>
                                        <td> {{ $i }} </td>
                                        <td> Well Group Department {{ $i }} </td>
                                        <td> Department description {{ $i }} </td>
                                        <td>
