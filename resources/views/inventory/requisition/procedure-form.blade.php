<div class="row">
        <div class="col-lg-3 col-sm-3">
            <div class="form-group{{ $errors->has('code') ? ' has-error' : '' }}">
                ...
                {{ Form::text('code',old('code'),['class'=>'form-control','placeholder'=>'00015','autofocus','required' ]) }}
        ...
        <div class="col-lg-3 col-sm-3">
            <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                {{Form::label('', 'Quantity', ['class'=>'label-control'])}}
                {{ Form::text('price',null,['class'=>'form-control','autofocus','required','placeholder'=>'Ex. 50']) }}
    ...
    <div class=" col-lg-3">
        <div class="form-group">
            {{ Form::button("Add To Requisition List",['class'=>'btn btn-primary btn-block']) }}
        </div>
    </div>
